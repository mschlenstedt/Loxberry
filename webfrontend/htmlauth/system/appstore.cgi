...
# "evtl. nicht aktuell"-Banner bei veraltetem /dev/shm-Cache (server nicht
# erreichbar) oder persistentem Fallback (max. 24h alte SD-Kopie). Kein Banner
# bei frischem Cache (innerhalb TTL) oder Live-Daten.
