...
#
# Updating db_maint (notification and logfile database maintenance)
#
LOGINF "Updating job for notification and logfile maintenance";
copy_to_loxberry("/system/cron/cron.weekly/db_maint");

LOGINF "Setting maintenance jobs to +x";
